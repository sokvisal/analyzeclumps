...
def squared(inputArray, scale_min=None, scale_max=None, a=5.):
	"""Performs squared scaling of the input numpy array.
	...
	imageData = numpy.square(imageData) #/ numpy.square(scale_max - scale_min)
	return imageData

def pow(inputArray, scale_min=None, scale_max=None, a=5.):
